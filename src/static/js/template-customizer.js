...
TemplateCustomizer.LANGUAGES = {
    uz: {
        ...
        panel_sub_header: 'Sozlamalarni real vaqtda ko‘rib chiqing',
        theming_header: 'Mavzular',
        style_label: 'Uslub (Rejim)',
        theme_label: 'Mavzular',
        layout_header: 'Tuzilish',
        layout_label: 'Menyu (Navigatsiya)',
        layout_header_label: 'Sarlavha turlari',
        content_label: 'Kontent',
        layout_navbar_label: 'Navigatsiya paneli turi',
